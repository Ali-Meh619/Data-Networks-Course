...
NS_LOG_COMPONENT_DEFINE ("Lab3_part4-2");
...
CommandLine cmd;
    ...
    std::string animFile = "lab3_part4-2.xml";
...
p2p.EnableAsciiAll (ascii.CreateFileStream ("Lab3_part4-2.tr"));
p2p.EnablePcapAll ("Lab3_part4-2");
}
